...
function menu() {
	...
	html = html + '<ul>'
	html = html + '<li><a href="/setupClass">Class Registration</a></li>';
	html = html + '<li><a href="/setupStudentSearch">Student Search</a></li>';
	html = html + '<li><a href="/setupStudentAdd">Student Registration</a></li>';
	html = html + '</ul>';
	html = html + '</li>';
	html = html + '<li id="no-child">';
	html = html + '<a href="/setupUser" style="font-weight:bold;">User Management</a>';
	html = html + '</li>';
	html = html + '</ul>';
	html = html + '</div>';
